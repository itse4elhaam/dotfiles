...
import { applyApprovedChanges, createCandidateWorktree, applyCandidateChanges, discardWorktree, getWorktreeDiff, } from "./worktree.js";
...
// ---------------------------------------------------------------------------
const createProposeTool = (config) => tool({
...
// ---------------------------------------------------------------------------
const createContextPackTool = (config) => tool({
...
// ---------------------------------------------------------------------------
const createEvaluateTool = (config) => tool({
...
// ---------------------------------------------------------------------------
const createWorktreeTool = (config) => tool({
...
// ---------------------------------------------------------------------------
const createValidateTool = (config) => tool({
...
// ---------------------------------------------------------------------------
const createApplyTool = (config) => tool({
...
// Main: SelfModPlugin
// ---------------------------------------------------------------------------
export const SelfModPlugin = async (_input, options) => {
